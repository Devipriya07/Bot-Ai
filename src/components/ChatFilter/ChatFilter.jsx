//component to be used in history page

import { Box, Select, MenuItem, Typography } from '@mui/material'
import { useEffect, useState } from 'react'

export default function ChatFilter({ allChats, filterChats }) {// both-taken from history component
    ...
    useEffect(() => {
        ...
        if (option === 'All Ratings') {
            ...
            const filtered = allChats.filter(item => {
                ...
                }) //closing of forEach statement
                return found
            }) //closing of filter statement
