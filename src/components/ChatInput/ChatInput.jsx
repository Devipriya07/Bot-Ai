...
export default function ChatInput({ generateResponse, setScroll, chat, clearChat }) {
    ...
    const handleSave = () => {
        ...
        clearChat();// to display new page after saving
        setShowSnackbar(true);// display notification after saving
    }
        ...
        <Box flexShrink={0} px={{ xs: .5, md: 3 }} pb={{ xs: 1, md: 3 }}>
            <Box component={'form'} onSubmit={handleSubmit}>
                <Stack
                    ...
                    <Button 
                        type='button' //type does not exhibit any speacial behaviour
                        variant='outlined'
                        onClick={handleSave}
